            ...
            <div className="container mx-auto px-4">
                ...
                <ScrollSection id="about">
                    ...
                    <div className="prose dark:prose-invert max-w-none">
                        ...
                        <p className="mb-3 text-gray-300" style={{ color: '#cfdbe8' }}>I am continuously expanding my skillset and seeking new opportunities in all fields of software development, including web development, mobile development, and data analysis. One of the most rewarding aspects of my work is the ability to create something that can have a positive impact on people's lives.</p>
                        <p className="mb-3 text-gray-300" style={{ color: '#cfdbe8' }}>One of the sectors I have a particular passion for is Finance, and I love exploring the role software can play in the industry. AI/ML trading algorithms with deep forensic analysis capabilities will likely have a disruptive impact on the industry, and I am excited to be a part of that.</p>
                        <p className="mb-3 text-gray-300" style={{ color: '#cfdbe8' }}>I am also a big fan of 3D graphics, and I love how they can be used to represent data in a more engaging way. Like 3D Audio visualizers, or 3D representations of user interfaces in AR/VR.</p>
                        <br />
                        <p className="mb-3 text-gray-300" style={{ color: '#cfdbe8' }}>Normally I would just list out my skills, but why do that when I can make them spin around in 3D instead?</p>
